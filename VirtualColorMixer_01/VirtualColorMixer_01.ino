...
void loop() {
  ...
  red = analogRead(redPin); // 0 1023
  green = analogRead(greenPin);
  blue = analogRead(bluePin);

  analogWrite(redPinLed, map(red, 0, 1023, 0, 255)); // 0 255
  analogWrite(greenPinLed, map(green, 0, 1023, 0, 255));
  analogWrite(bluePinLed, map(blue, 0, 1023, 0, 255));
